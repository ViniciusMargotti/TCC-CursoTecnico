...
$sql = "SELECT * FROM pedidos where pedidos.status= 'Andamento' and id_pedido LIKE '%".strtoupper($_POST['like'])."%'  ";
...
echo "<th width='100%'> Finalizar </th>";
echo "</tr>";
echo"</thead>";
echo"<tbody>";
...
while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
	...
	echo"<td   >";
	echo "<button style='width:100%;'  onclick='AlteracaoPedido(". $registro['id_pedido']." , 2) '; class='btn btn-success'>  <i class='material-icons'>done</i></button>";
	echo"</td>";
