...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Out-2018 às 21:53
...
(426, 126, 30, 1, 2, 0, '', 'null', 1),
(427, 126, 7, 0.5, 28, 0, 'Sem coração', 'media', 1),
(428, 126, 11, 0.5, 22, 0, '', 'media', 1),
(429, 126, 32, 1, 3, 0, '', 'null', 1),
...
(126, '2018-04-05', 19, '2018-10-05 16:34:52', 45.5, 'Cartão', 'Arquivado', 0.5),
(159, '2018-06-08', 30, '2018-10-05 19:01:16', 324, 'Dinheiro', 'Andamento', 7),
(160, '2018-07-08', 30, '2018-03-05 19:01:22', 324, 'Dinheiro', 'Andamento', 7),
(161, '2018-08-08', 30, '2018-10-05 19:01:22', 324, 'Dinheiro', 'Andamento', 7),
(162, '2018-01-08', 30, '2018-03-05 19:01:22', 324, 'Dinheiro', 'Pendente', 7),
(163, '2018-01-02', 30, '2018-10-05 19:01:35', 324, 'Dinheiro', 'Pendente', 7),
(164, '2018-11-08', 30, '2018-10-05 19:01:35', 324, 'Dinheiro', 'Pendente', 7),
...
(49, 'teste', 1312, 'teste', 1, 'Ativo'),
(50, 'teste', 123, 'teste', 1, 'Ativo');
...
--
ALTER TABLE `carrinho`
  MODIFY `id_item_carrinho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=324;
...
--
ALTER TABLE `itens_pedidos`
  MODIFY `id_item` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=469;

--
-- AUTO_INCREMENT for table `pedidos`
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
